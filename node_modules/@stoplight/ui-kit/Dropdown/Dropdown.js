...
exports.Dropdown = (_a) => {
    ...
    return React.createElement(baseComponent, Object.assign({ filterable: false, items,
        itemRenderer,
        itemListRenderer, popoverProps: Object.assign(Object.assign({}, popoverProps), { portalClassName: classnames_1.default('Dropdown__popover', popoverProps ? popoverProps.portalClassName : '') }) }, props), children);
};
