...
export declare function salign<F, A>(
  F: Align<F>,
  S: Semigroup<A>
): (fx: HKT<F, A>, fy: HKT<F, A>) => HKT<F, A>;
/**
...
export declare function padZip<F extends URIS3, L>(
  ...
  fa: Kind3<F, U, L, A>,
  fb: Kind3<F, U, L, B>
) => Kind3<F, U, L, [Option<A>, Option<B>]>;
export declare function padZip<F extends URIS2>(
  F: Align2<F>
): <L, A, B>(
  fa: Kind2<F, L, A>,
  fb: Kind2<F, L, B>
) => Kind2<F, L, [Option<A>, Option<B>]>;
...
export declare function padZip<F>(
  F: Align<F>
): <A, B>(fa: HKT<F, A>, fb: HKT<F, B>) => HKT<F, [Option<A>, Option<B>]>;
/**
