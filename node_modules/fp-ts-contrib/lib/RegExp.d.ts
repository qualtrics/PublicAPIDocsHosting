...
export declare function match(
  r: RegExp
): (s: string) => O.Option<RegExpMatchArray>;
/**
 ...
 * @since 0.1.8
 */
export declare function test(r: RegExp): Predicate<string>;
/**
 ...
 * @since 0.1.8
 */
export declare function split(r: RegExp): (s: string) => NonEmptyArray<string>;
