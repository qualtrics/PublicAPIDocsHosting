...
export declare function filterA<F extends URIS4>(
  ...
  p: (a: A) => Kind4<F, S, R, E, boolean>
) => (as: Array<A>) => Kind4<F, S, R, E, Array<A>>;
export declare function filterA<F extends URIS3>(
  F: Applicative3<F>
): <R, E, A>(
  p: (a: A) => Kind3<F, R, E, boolean>
) => (as: Array<A>) => Kind3<F, R, E, Array<A>>;
export declare function filterA<F extends URIS2>(
  F: Applicative2<F>
): <E, A>(
  p: (a: A) => Kind2<F, E, boolean>
) => (as: Array<A>) => Kind2<F, E, Array<A>>;
