export function getRedirect(path: string, anchor: string) {
    let redirectMap = new Map([
        [
            ...
            "/0f8fac59d1995-api-reference"
        ],
        [
            "/docs/overview.md",
            "/ZG9jOjcxMjYx-overview"
        ],
        //GUIDES
        [
            "/docs/Guides/Actions and Webhooks/actions.md",
            "/ZG9jOjg3NzY2NQ-actions"
        ],
        [
        ...
        //INSTRUCTIONS
        [
            "/docs/Instructions/overview.md",
            "/8shbk1msh6f05-overview",
        ],
        [
        ...
        [
            "/docs/Instructions/Reference/parameters.md",
            "/74fdff2f219cb-parameters",
        ],
        [
            "/docs/Instructions/Reference/responses.md",
            "/3ab4b937676d5-responses",
        ],
        [
            "/docs/Instructions/Reference/limits.md",
            "/a5e9a1a304902-limits",
        ],
        [
        ...
        [
            "/docs/Instructions/other-apis.md",
            "/be8786a7378fb-other-ap-is",
        ],
        [
